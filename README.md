...
1. Read the project list on the screen.
2. Browse by topic or category.
3. Open any project link you want to inspect.
4. Use the list to compare tools and repo types.
5. Save useful links in your browser bookmarks.
...
4. Open the app or list.
5. Browse the agent and RL projects.
6. Open the ones that match your goal.
